...
import { HealthData, HealthWorkout, parseHealthData, formatWorkoutForHealthApp } from '@/integrations/health-apps';
import { dbService } from '@/services/indexeddb-service';
import api from '@/services/api';
import { IndexedDBError, IndexedDBErrorType } from '@/services/indexeddb-service';
...
export const healthSyncService = {
  ...
  initialize: async (): Promise<void> => {
    try {
      ...
      const transaction = await dbService.startTransaction(['healthData'], 'readonly');
