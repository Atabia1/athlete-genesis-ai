 ...
 */
function validateString(value: any, fieldName: string): string | null {
 ...
 */
function validateArray(value: any, fieldName: string): string | null {
  if (value === undefined || value === null) {
    return `${fieldName} is required`;
  }
 ...
 */
export function validateWorkoutDay(day: any): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateWorkoutPlan(plan: any): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateFood(food: any): ValidationResult {
  const errors: string[] = [];
 ...
 */
export function validateDailyMealPlan(dailyPlan: any): ValidationResult {
  const errors: string[] = [];
  ...
  if (mealsError) {
    ...
    // Validate each meal
    dailyPlan.meals.forEach((meal: any, index: number) => {
 ...
 */
export function validateMealPlan(plan: any): ValidationResult {
  const errors: string[] = [];
  ...
  if (dailyPlansError) {
    ...
    if (plan.dailyPlans.length === 0) {
      ...
      plan.dailyPlans.forEach((dailyPlan: any, index: number) => {
 ...
 */
export function validateData(data: any, type: 'workout' | 'meal'): ValidationResult {
  if (!data) {
    return {
      valid: false,
